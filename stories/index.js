...
storiesOf("InterviewerListItem", module)
  ...
  .add("Clickable", () => (
    <InterviewerListItem
      ...
      name={interviewer.name}
      avatar={interviewer.avatar}
      onChangeInterviewer={event =>
        action("onChangeInterviewer")(interviewer.id)
      }
    />
  ));
...
storiesOf("Appointment", module)
  ...
  .add("Deleting Status", () => <Status message="Deleting" />)
  .add("Saving Status", () => <Status message="Saving" />)
  .add("Error Deleting", () => (
    <Error
  ...
  .add("Appointment Booked", () => (
    <Fragment>
      <Appointment
        id={1}
        time="12pm"
        interview={{ student: "Jackson Stark", interviewer }}
      />
      <Appointment id="last" time="1pm" />
    </Fragment>
  ));
